  ...
  render() {
    return (
      <div className="bg-banner">
        <div className="bg-banner position-relative overflow-hidden py-5 text-center">
          <div className="col-md-5 col-lg-8 col-md-8 mx-sm-4 my-5">
            <div className="panel bg">
            <h2 className="title display-4 text-uppercase text-right text-white">
          ...
          <div className="panel-button pt-3">
            <Link to="#aboutUs">
              <Button type="button" className="btn square btn-lg">
                Learn More
              </Button>
            </Link>
            <br />
