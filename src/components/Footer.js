              ...
              <div className="row footer">
                ...
                <div className="col-6 col-md">
                  <ul className="list-unstyled text-small">
                    <a href='#'><h2 className="font-weight-normal">Tatong</h2></a><br/>
                   <small className="d-block mb-3 text-muted">&copy; 2017-2018</small>
                  </ul>
                </div>

                <div className="col-12 col-lg-3 py-4">
                  <i className="fas fa-at"></i><a href="http://sample.com/"><small className="text-muted site"> www.sample.com</small></a> <br/ >
                  <i className="fas fa-phone"></i><small className="text-muted"> 000-0000 </small><br/ >
                  <i className="fas fa-envelope"></i><small className="text-muted">info@sample.ph</small> <br/ ><hr/>
